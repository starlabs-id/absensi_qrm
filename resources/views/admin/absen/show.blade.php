            ...
            <div class="card-body">
                <h4 class="card-title mb-3">
                    ...
                    <span class="pull-right">
                        ...
                        <a href="{{ route('admin.absen.create') }}" class="btn btn-primary btn-sm pull-right">Absen</a>
                    </span>
                </h4>
                <br>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{ route('admin.absen.edit', $absen->id) }}" class="btn btn-sm btn-danger">Absen Pulang</a>
