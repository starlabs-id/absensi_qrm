                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    @can('projek-destroy')
                                        ...
                                        <a href="{{ route('projek.delete', $row->id) }}" class="btn btn-danger btn-sm" onclick="return confirm('Apakah anda ingin menghapus data ini ?')">Hapus</a>
                                    @endcan
                                    @if($row->approval_ap1 == 'Belum')
                                    @elseif($row->approval_app == 'Diterima')
                                        <a href="{{ route('pdf.so', $row->id) }}" class="btn btn-success btn-sm" target="_blank">SO PDF</a>
                                    @else
                                    @endif
                                </td>
                            </tr>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="{{ route('projek.approval_app') }}" method="post" id="frm-edit" class="row needs-validation" novalidate>
                                {{ csrf_field() }}
                ...
                <div class="modal fade" id="modal-approval-ap1">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="{{ route('projek.approval_ap1') }}" method="post" id="frm-edit" class="row needs-validation" novalidate>
                                {{ csrf_field() }}
