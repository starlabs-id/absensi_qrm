...
<div class="col-md-12">
    <div class="card mb-4">
        <div class="card-body">
            <div class="card-title mb-3">Edit Shift</div>
            <form >
                <div class="row">
                    ...
                    <div class="col-md-12 form-group mb-3">
                        ...
                        <input type="text" class="form-control" id="jam_masuk" name="jam_masuk" required value="">
                    </div>
                    <div class="col-md-12 form-group mb-3">
                        <label for="jam_pulang">Jam Pulang</label>
                        <input type="text" class="form-control" id="jam_pulang" name="jam_pulang" required value="">
                    </div>
